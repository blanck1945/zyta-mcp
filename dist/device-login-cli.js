...
async function main() {
    ...
    if (!baseUrl) {
        console.error("Definí KAIRO_API_BASE_URL (o ZYTA_API_BASE_URL) antes de ejecutar login:device.");
        process.exit(1);
    }
    ...
    console.log("Listo. Token guardado en:", outPath);
    console.log("En Cursor podés usar solo KAIRO_API_BASE_URL en la config MCP (sin JWT en el JSON).");
}
main().catch((e) => {
